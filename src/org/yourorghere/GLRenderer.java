...
gunakan 
-
1 untuk arah berlawanan dengan vektor awal
     */
    ...
    private void cameraRotation(vector reference, double angle) {
        ...
        float cross_product_x = (Up_y1 * VLz)
                - (VLy * Up_z1);
        float cross_product_y
                = -((Up_x1 * VLz)
                - (Up_z1 * VLx));
        float cross_product_z = (Up_x1 * VLy)
                - (Up_y1 * VLx);
...
//huruf W
        if (keyCode == 87) {
            ...
            vectorMovement(depanBelakang, 2f,
                    -1f);
        } //huruf A
        else if (keyCode == 68) {
            ...
            angle_vertikal += 15f;
            samping.vectorRotation(vertikal, angle_vertikal
                    - angle_vertikal2);
            depanBelakang.vectorRotation(vertikal,
                    angle_vertikal
                    - angle_vertikal2);
            cameraRotation(vertikal, angle_vertikal
                    - angle_vertikal2);
